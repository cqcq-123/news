				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							<form class="form-horizontal" action="roleControl/roleID" method="post">
								<fieldset>
									<c:forEach items="${list}" var="role">
										...
										<div class="control-group success">
											...
											<div class="controls">
												<input type="text" id="roleCode" name="roleCode" value="${role.roleCode}"> <span
										...
										<div class="control-group success">
											...
											<div class="controls">
												<input type="text" id="roleName" name="roleName" value="${role.roleName}"> <span
													class="help-inline"></span>
											</div>
										</div>
										<div class="control-group success">
											...
											<div class="controls">
												<input type="text" id="createdBy" name="createdBy" value="${role.createdBy}"> <span
													class="help-inline"></span>
											</div>
										</div>
										<div class="control-group success">
											...
											<div class="controls">
												<input type="text" class="input-xlarge datepicker"
													   id="creationDate" name="creationDate" value="${role.creationDate}">
											</div>
										</div>
