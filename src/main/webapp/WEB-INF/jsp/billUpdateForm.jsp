				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							<form class="form-horizontal" action="billControl/billID" method="post">
								<fieldset>
									...
									<div class="control-group error">
										<label class="control-label" for="billCode">账单编码</label>
										<div class="controls">
											<input type="text" id="billCode" name="billCode" value="${bill.billCode}"> <span
									...
									<div class="control-group error">
										...
										<div class="controls">
											<input type="text" id="productName" name="productName" value="${bill.productName}"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group error">
										<label class="control-label" for="productDesc">商品描述</label>
										<div class="controls">
											<input type="text" id="productDesc" name="productDesc" value="${bill.productDesc}"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group error">
										<label class="control-label" for="productUnit">商品单位</label>
										<div class="controls">
											<input type="text" id="productUnit" name="productUnit" value="${bill.productUnit}"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group error">
										...
										<div class="controls">
											<input type="text" id="productCount" name="productCount" value="${bill.productCount}"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group error">
										<label class="control-label" for="totalPrice">商品总额</label>
										<div class="controls">
											<input type="text" id="totalPrice" name="totalPrice" value="${bill.totalPrice}"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group error">
										<label class="control-label" for="isPayment">是否支付</label>
										<div class="controls">
											<input type="text" id="isPayment" name="isPayment" value="${bill.isPayment}"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group error">
										...
										<div class="controls">
											<input type="text" id="createdBy" name="createdBy" value="${bill.createdBy}"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" class="input-xlarge datepicker"
												   id="creationDate" name="creationDate" value="${bill.creationDate}">
										</div>
									</div>
