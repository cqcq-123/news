				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							<form class="form-horizontal" action="roleControl/toRoleForm" method="post">
								<fieldset>
									<div class="control-group success">
										<label class="control-label" for="roleCode">角色编码</label>
										<div class="controls">
											<input type="text" id="roleCode" name="roleCode"> <span
									...
									<div class="control-group success">
										...
										<div class="controls">
											<input type="text" id="roleName" name="roleName"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group success">
