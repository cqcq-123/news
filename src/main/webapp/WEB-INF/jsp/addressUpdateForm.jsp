				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							<form class="form-horizontal" action="addressControl/addressID" method="post">
								<fieldset>
									<c:forEach items="${list}" var="address">
										...
										<div class="control-group success">
											...
											<div class="controls">
												<input type="text" id="contact" name="contact" value="${address.contact}"> <span
										...
										<div class="control-group success">
											...
											<div class="controls">
												<input type="text" id="addressDesc" name="addressDesc" value="${address.addressDesc}"> <span
													class="help-inline"></span>
											</div>
										</div>
										<div class="control-group success">
											...
											<div class="controls">
												<input type="text" id="postCode" name="postCode" value="${address.postCode}"> <span
													class="help-inline"></span>
											</div>
										</div>
										<div class="control-group success">
											...
											<div class="controls">
												<input type="text" id="tel" name="tel" value="${address.tel}"> <span
													class="help-inline"></span>
											</div>
										</div>
										<div class="control-group success">
											...
											<div class="controls">
												<input type="text" id="createdBy" name="createdBy" value="${address.createdBy}"> <span
													class="help-inline"></span>
											</div>
										</div>
										<div class="control-group success">
											...
											<div class="controls">
												<input type="text" class="input-xlarge datepicker"
													   id="creationDate" name="creationDate" value="${address.creationDate}">
											</div>
										</div>
