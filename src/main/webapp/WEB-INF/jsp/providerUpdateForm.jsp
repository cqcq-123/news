				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							<form class="form-horizontal" action="providerControl/providerID" method="post">
								<fieldset>
									...
									<div class="control-group warning">
										<label class="control-label" for="proCode">供应商编码</label>
										<div class="controls">
											<input type="text" id="proCode" name="proCode" value="${provider.proCode}"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group warning">
										<label class="control-label" for="proName">供应商名称</label>
										<div class="controls">
											<input type="text" id="proName" name="proName" value="${provider.proName}"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group warning">
										<label class="control-label" for="proDesc">供应商详细描述</label>
										<div class="controls">
											<input type="text" id="proDesc" name="proDesc" value="${provider.proDesc}"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group warning">
										<label class="control-label" for="proContact">供应商联系人</label>
										<div class="controls">
											<input type="text" id="proContact" name="proContact" value="${provider.proContact}"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group warning">
										<label class="control-label" for="proPhone">联系电话</label>
										<div class="controls">
											<input type="text" id="proPhone" name="proPhone" value="${provider.proPhone}"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group warning">
										<label class="control-label" for="proAddress">地址</label>
										<div class="controls">
											<input type="text" id="proAddress" name="proAddress" value="${provider.proAddress}"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group warning">
										<label class="control-label" for="proFax">传真</label>
										<div class="controls">
											<input type="text" id="proFax" name="proFax" value="${provider.proCode}"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group warning">
										...
										<div class="controls">
											<input type="text" id="createdBy" name="createdBy" value="${provider.createdBy}"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" class="input-xlarge datepicker"
												   id="creationDate" name="creationDate" value="${provider.creationDate}">
										</div>
									</div>
