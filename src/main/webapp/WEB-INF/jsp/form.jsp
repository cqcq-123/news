			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="${pageContext.request.contextPath}/providerControl/file-manager"><i
						...
						<div class="box-content">
							<form class="form-horizontal">
								<fieldset>
									...
									<div class="control-group">
										<label class="control-label" for="skin_push_time">Date input</label>
										<div class="controls">
											<input type="text"
												id="skin_push_time" name="skin_push_time" value="02/16/12">
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<label class="checkbox inline"> <input
												...
												Option 1 </label> <label class="checkbox inline"> <input
												type="checkbox" id="inlineCheckbox2" value="option2">
												Option 2 </label> <label class="checkbox inline"> <input
