				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							<form class="form-horizontal" action="billControl/tobillForm" method="post">
								<fieldset>
									<div class="control-group error">
										<label class="control-label" for="billCode">账单编码</label>
										<div class="controls">
											<input type="text" id="billCode" name="billCode"> <span
									...
									<div class="control-group error">
										...
										<div class="controls">
											<input type="text" id="productName" name="productName"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group error">
										...
										<div class="controls">
											<input type="text" id="productDesc" name="productDesc"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group error">
										...
										<div class="controls">
											<input type="text" id="productUnit" name="productUnit"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group error">
										...
										<div class="controls">
											<input type="text" id="productCount" name="productCount"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group error">
										...
										<div class="controls">
											<input type="text" id="totalPrice" name="totalPrice"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group error">
										...
										<div class="controls">
											<input type="text" id="isPayment" name="isPayment"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group error">
