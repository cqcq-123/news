			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="${pageContext.request.contextPath}/providerControl/tour"><i class="icon-globe"></i><span
								class="hidden-tablet"> Tour</span> </a>
						</li>
				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							<form class="form-horizontal" action="/userControl/userID" method="post">
								<fieldset>
									...
									<div>
										...
										<div class="control-group warning">
											...
											<div class="controls">
												<input type="text" id="userCode" name="userCode" value="${user.userCode}"> <span
										...
										<div class="control-group warning">
											...
											<div class="controls">
												<input type="text" id="userName" name="userName" value="${user.userName}"> <span
													class="help-inline"></span>
											</div>
										</div>
										<div class="control-group warning">
											...
											<div class="controls">
												<input type="text" id="userPassword" name="userPassword" value="${user.userPassword}"> <span
													class="help-inline"></span>
											</div>
										</div>
										<div class="control-group warning">
											...
											<div class="controls">
												<input type="text" id="gender" name="gender" value="${user.gender}"> <span
													class="help-inline"></span>
											</div>
										</div>
										<div class="control-group warning">
											...
											<div class="controls">
												<input type="text" id="birthday" name="birthday" value="${user.birthday}"> <span
													class="help-inline"></span>
											</div>
										</div>
										<div class="control-group warning">
											...
											<div class="controls">
												<input type="text" id="phone" name="phone" value="${user.phone}"> <span
													class="help-inline"></span>
											</div>
										</div>
										<div class="control-group warning">
											...
											<div class="controls">
												<input type="text" id="address" name="address" value="${user.address}"> <span
													class="help-inline"></span>
											</div>
										</div>
										<div class="control-group warning">
											...
											<div class="controls">
												<input type="text" id="userRole" name="userRole" value="${user.userRole}"> <span
													class="help-inline"></span>
											</div>
										</div>
										<div class="control-group warning">
											...
											<div class="controls">
												<input type="text" id="createdBy" name="createdBy" value="${user.createdBy}"> <span
													class="help-inline"></span>
											</div>
										</div>
										<div class="control-group warning">
											...
											<div class="controls">
												<input type="text" class="input-xlarge datepicker"
													   id="creationDate" name="creationDate" value="${user.creationDate}">
											</div>
										</div>
