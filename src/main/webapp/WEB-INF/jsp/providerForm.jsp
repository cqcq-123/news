				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							<form class="form-horizontal" action="providerControl/toProviderForm" method="post">
								<fieldset>
									<div class="control-group warning">
										<label class="control-label" for="proCode">供应商编码</label>
										<div class="controls">
											<input type="text" id="proCode" name="proCode"> <span
									...
									<div class="control-group warning">
										...
										<div class="controls">
											<input type="text" id="proName" name="proName"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<textarea class="cleditor" id="proDesc" rows="3" name="proDesc"></textarea>
										</div>
									</div>
									<div class="control-group warning">
										<label class="control-label" for="proContact">供应商联系人</label>
										<div class="controls">
											<input type="text" id="proContact" name="proContact"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group warning">
										...
										<div class="controls">
											<input type="text" id="proPhone" name="proPhone"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group warning">
										...
										<div class="controls">
											<input type="text" id="proAddress" name="proAddress"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group warning">
										...
										<div class="controls">
											<input type="text" id="proFax" name="proFax"> <span
												class="help-inline"></span>
										</div>
									</div>
									<div class="control-group warning">
